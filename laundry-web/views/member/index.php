...
<div class="row mb-4 align-items-center">
    <div class="col-md-6">
        ...
        <p class="text-muted mb-0">Daftar pelanggan setia LaundryKu.</p>
    </div>
...
<style>
    /* Styling agar input pencarian sama dengan Outlet */
    .dataTables_filter { 
        margin-bottom: 25px; 
    }
    ...
    .dataTables_filter input:focus {
        border-color: #0d6efd; /* Warna biru primary untuk member */
