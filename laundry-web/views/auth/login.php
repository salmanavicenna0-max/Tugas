              ...
              <div class="card-body p-md-5 mx-md-4">
                ...
                <form action="index.php" method="POST">
                  ...
                  <div class="d-flex align-items-center justify-content-center">
                    <p class="mb-0 small text-muted opacity-50">© 2026 LaundryKu Premium</p>
                  </div>
                </form>
            ...
            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
              <div class="text-white px-3 py-4 p-md-5 mx-md-4 text-center text-lg-start">
                ...
                <p class="lead mb-0 opacity-75" style="font-size: 1rem; line-height: 1.8;">
                    Kelola operasional laundry dengan lebih cerdas. 
                    Mulai dari pencatatan member, manajemen multi-outlet, hingga laporan otomatis dalam satu dashboard profesional.
                </p>
