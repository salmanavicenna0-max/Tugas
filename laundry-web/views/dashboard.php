    ...
    <div class="row g-4 mb-4">
        <div class="col-md-4">
            <div class="card border-0 shadow-sm p-3" style="border-left: 5px solid #0d6efd; border-radius: 12px;">
                <div class="d-flex align-items-center">
                    <i class="bi bi-people-fill fs-1 text-primary me-3 opacity-25"></i>
                    <div>
                        <small class="text-muted d-block fw-bold">TOTAL PELANGGAN</small>
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm p-3" style="border-left: 5px solid #198754; border-radius: 12px;">
                <div class="d-flex align-items-center">
                    <i class="bi bi-shop fs-1 text-success me-3 opacity-25"></i>
                    <div>
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm p-3" style="border-left: 5px solid #ffc107; border-radius: 12px;">
                <div class="d-flex align-items-center">
                    <i class="bi bi-person-badge fs-1 text-warning me-3 opacity-25"></i>
                    <div>
                        <small class="text-muted d-block fw-bold">TOTAL PETUGAS</small>
        ...
        <div class="col-lg-6">
            <div class="card border-0 shadow-sm p-4" style="border-radius: 15px;">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h5 class="fw-bold mb-0"><i class="bi bi-person-check me-2 text-primary"></i> Member Baru</h5>
